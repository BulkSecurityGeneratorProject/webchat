...
var _1 = require("./");
var WebchatSharedModule = /** @class */ (function () {
    function WebchatSharedModule() {
    }
    WebchatSharedModule = __decorate([
        core_1.NgModule({
            imports: [
                _1.WebchatSharedLibsModule,
                _1.WebchatSharedCommonModule
            ],
            declarations: [
    ...
    return WebchatSharedModule;
}());
exports.WebchatSharedModule = WebchatSharedModule;
